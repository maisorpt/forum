  ...
  switch (action.type) {
    ...
    case ActionType.TOGGLE_UPVOTE_THREAD_DETAIL:
      if (action.payload.userId) {
        const isUpvoted = threadDetail.upVotesBy
          && threadDetail.upVotesBy.includes(action.payload.userId);
        const isDownvoted = threadDetail.downVotesBy
      ...
      return {
        ...
        comments: threadDetail.comments.map((comment) => {
          if (comment.id === action.payload.commentId) {
            const isCommentUpvoted = comment.upVotesBy
              && comment.upVotesBy.includes(action.payload.userId);
            const isCommentDownvoted = comment.downVotesBy
